...
public class BasePage extends DriverFactory {
	...
	public static String returnScreenshotName() {
		...
		System.out.println("\n*** screenshotName = " + strScreenshotName + " ***\n");
	...
	public static void captureScreenshot() throws IOException, InterruptedException {
		...
		String returnScreenshotName = returnScreenshotName();
		
		FileUtils.copyFile(srcFile, new File( returnScreenshotName ) );
		System.out.println("\n*** srcFile = "+ returnScreenshotName + " ***\n");
		...
		try {
		  ...
		  Reporter.addStepLog("<a target=\"_blank\", href="+ returnScreenshotName + "><img src="+ returnScreenshotName + " height=200 width=300></img></a>");
			...
			throw new RuntimeException( "\n*** Class BasePage, method captureScreenshot(): could not add the screenshot to the logging ***\n", e);
		}
	}

...
public class BasePage extends DriverFactory {
	...
	public static String returnScreenshotName() {
		...
		String strScreenshotName = System.getProperty("user.dir") + "/output/imgs/" + screenshotName;
	...
	public static void captureScreenshot() throws IOException, InterruptedException {
		System.out.println("\n*** Method captureScreenshot() Starting ***\n");
		
		File srcFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		System.out.println("\n*** srcFile = "+ srcFile.getAbsolutePath() + " ***\n");
		
		String strReturnScreenshotName = returnScreenshotName();
		
		FileUtils.copyFile(srcFile, new File( strReturnScreenshotName ) );
		System.out.println("\n*** srcFile = "+ strReturnScreenshotName + " ***\n");
		
		
//		Reporter.addStepLog("Taking a screenshot!");
//		Reporter.addStepLog("<br>");
//		/**
//		 * _blank will open the image in a new browser tab if clicked upon.
//		 * Source: https://html.com/attributes/a-href/
//		 */
//		Reporter.addStepLog("<a target=\"_blank\", href="+ strReturnScreenshotName + "><img src="+ strReturnScreenshotName + " height=200 width=300></img></a>");
	}
